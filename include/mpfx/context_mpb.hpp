...
public:
    ...
    static bool __overflow_to_infinity(RM rm, bool s, bool maxval_odd) {
    ...
    static double __round_overflow(double x, RM rm, double maxval, bool maxval_odd) {
    ...
    inline double round(double x) const override {
        ...
        return __round_overflow(x, mps_ctx_.rm(), maxval_, maxval_odd_);
    }
