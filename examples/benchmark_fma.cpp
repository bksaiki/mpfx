...
double benchmark_mpfx_fma(const std::vector<double>& x_vals, 
    ...
    for (size_t i = 0; i < n; i++) {
        result = mpfx::fma(x_vals[i], y_vals[i], z_vals[i], ctx);
    }
...
int main() {
    ...
    std::cout << "=======================================================\n";
    std::cout << "   MPFX vs MPFR vs SoftFloat Fused Multiply-Add Benchmark\n";
    std::cout << "=======================================================\n";
    ...
    // Benchmark MPFX
    std::cout << "Benchmarking MPFX fma()...\n";
    double mpfx_time = benchmark_mpfx_fma(x_vals, y_vals, z_vals, PRECISION, ROUNDING_MODE);
    std::cout << "Done.\n\n";
    ...
    std::cout << "MPFX fma():               " << mpfx_time << " ns/op\n";
