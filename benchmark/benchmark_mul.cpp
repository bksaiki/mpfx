...
double benchmark_mpfx_mul(const std::vector<double>& x_vals, 
    ...
    for (size_t i = 0; i < n; i++) {
        result = mpfx::mul(x_vals[i], y_vals[i], ctx);
    }
...
int main() {
    ...
    std::cout << "=======================================================\n";
    std::cout << "   MPFX vs MPFR vs SoftFloat Multiplication Benchmark\n";
    std::cout << "=======================================================\n";
    ...
    // Benchmark MPFX
    std::cout << "Benchmarking MPFX mul()...\n";
    double mpfx_time = benchmark_mpfx_mul(x_vals, y_vals, PRECISION, ROUNDING_MODE);
    std::cout << "Done.\n\n";
    ...
    std::cout << "MPFX mul():               " << mpfx_time << " ns/op\n";
